...
def gpt_responder(user_review:str, responder_prompt_number:int = 0, responder_temperature:float = 0, User_Sentiment:str = None, User_Emotion:str = None, User_Intention:str = None, model:str = "gpt-4o-2024-11-20"):
